...
struct OnboardingView: View {
    ...
    // MARK: - Step 5: Connect Partner
    private var connectPartnerStep: some View {
        VStack(spacing: 0) {
            Spacer()
            ...
            ZStack {
                Circle()
                    .fill(RadialGradient(
                        colors: [Color.partnerPrimary.opacity(0.15), Color.partnerSecondary.opacity(0.08), Color.clear],
                        center: .center, startRadius: 20, endRadius: 120
                    ))
                ...
                ZStack {
                    Circle()
                        .fill(LinearGradient(
                            colors: [Color.partnerPrimary.opacity(0.12), Color.partnerSecondary.opacity(0.08)],
                            startPoint: .topLeading, endPoint: .bottomTrailing
                        ))
